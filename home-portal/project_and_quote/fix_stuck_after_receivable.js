...
if(window.location.href.substring(window.location.href.length-66,window.location.href.length)=="paFinancePanel%3AformWithPanels%3AreceivablesTab&action=#/project"){ 
   console.log("bad url");
