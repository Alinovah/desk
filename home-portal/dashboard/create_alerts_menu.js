...
function createMenu(){
  ...
  const jobs_overdue = document.createElement("div");
    ...
    jobs_overdue.innerText = "פרויקטים להגשה היום או באיחור:";
  ...
  const missing_receivables = document.createElement("div");
    ...
    missing_receivables.innerText = "פרויקטים להגשה היום או באיחור:";
  ...
  const missing_payables = document.createElement("div");
    ...
    missing_payables.innerText = "פרויקטים להגשה היום או באיחור:";
